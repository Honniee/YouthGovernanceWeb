...
/**
 * Sample Youth Data Generator
 * Creates realistic, diverse youth profiles for clustering testing
 */
  ...
  try {
    ...
    for (let i = 0; i < count; i++) {
      ...
      `, [
        ...
        youthClassification, registeredSKVoter, registeredNationalVoter,
        attendedKKAssembly, votedLastSK, timesAttended, reasonNotAttended
      ]);
...
async function main() {
  console.log('\n' + '═'.repeat(60));
  console.log('🎲 SAMPLE YOUTH DATA GENERATOR');
  console.log('═'.repeat(60));
  
  const YOUTH_PER_BARANGAY = 40; // Phase 4: MAXIMUM sample size for highest clustering quality (1,320 youth)
  ...
  try {
    ...
    console.error('\n' + '═'.repeat(60));
    console.error('❌ ERROR GENERATING SAMPLE DATA');
