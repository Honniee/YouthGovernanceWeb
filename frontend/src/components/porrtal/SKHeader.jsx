        ...
        <div className="flex items-center lg:order-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {unreadCount > 0 && (
                      <button
                        ...
                        className="flex items-center space-x-1 px-2 md:px-3 py-1 md:py-1.5 text-xs font-medium rounded-lg transition-all duration-200 text-blue-600 hover:text-blue-700 bg-blue-100 hover:bg-blue-200"
                      >
          ...
          <div className="relative ml-1 md:ml-2" ref={profileRef}>
            ...
            >
              <div className="flex items-center space-x-2 md:space-x-3.5">
                {/* Avatar */}
                <div className={`relative rounded-full ${showUserMenu ? 'ring-2 ring-green-200' : ''}`}>
