...
const AdminSidebar = ({ sidebarOpen, setSidebarOpen, onLogout }) => {
  ...
  const navigation = [
    ...
    { 
      name: 'Assign Officials', 
      href: '/admin/sk-governance/assign', 
      icon: Upload,
      description: 'Upload or manually assign SK officials to terms',
      category: 'governance'
    },
    { 
      name: 'Term History', 
      href: '/admin/sk-governance/history', 
      icon: History,
    ...
    <>
      ...
      >
        <div className="overflow-y-auto py-4 px-3 h-full bg-gradient-to-b from-white to-gray-50/30 dark:from-gray-800 dark:to-gray-900/30 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 dark:scrollbar-thumb-gray-600 dark:scrollbar-track-gray-800">
          ...
          <ul className="pt-4 mt-4 space-y-1 border-t border-gray-200/60 dark:border-gray-700/60">
            <li>
              <button
                onClick={onLogout}
                className="flex items-center p-2.5 w-full text-sm font-medium text-gray-700 rounded-lg transition-all duration-200 hover:bg-red-50 hover:text-red-600 hover:shadow-sm dark:text-gray-300 dark:hover:bg-red-900/20 dark:hover:text-red-400 group"
              >
                <div className="p-2 rounded-lg bg-red-100 dark:bg-red-900/30 group-hover:bg-red-200 dark:group-hover:bg-red-800/50 transition-all duration-200">
