...
const SuccessModal = ({ isOpen, message, onClose, title = 'Success' }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 bg-gray-300 bg-opacity-10 backdrop-blur-sm"></div>
      
      {/* Modal with responsive design */}
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm sm:max-w-md mx-4">
        {/* Header */}
        <div className="bg-green-50 rounded-t-2xl p-4 sm:p-6 pb-4 border-b border-gray-200">
