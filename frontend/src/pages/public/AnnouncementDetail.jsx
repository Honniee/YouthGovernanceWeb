...
const AnnouncementDetail = () => {
      ...
      try {
        ...
        if (resp?.success) {
          ...
          if (resp.data?.category) {
            const rel = await getAnnouncements({ status: 'published', category: resp.data.category, limit: 6, sortBy: 'published_at', sortOrder: 'DESC' });
            if (rel?.success) {
              setRelated((rel.data || []).filter(a => (a.announcement_id || a.id) !== (resp.data.announcement_id || resp.data.id)).slice(0, 3));
            }
          }
        } else {
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                  ...
                  <div className="p-8">
                    <div className="h-7 w-2/3 bg-gray-200 rounded mb-4 animate-pulse" />
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="space-y-3">
                    <div className="h-8 w-full bg-gray-200 rounded animate-pulse" />
                    <div className="h-8 w-5/6 bg-gray-200 rounded animate-pulse" />
                    <div className="h-8 w-4/6 bg-gray-200 rounded animate-pulse" />
                  </div>
                </div>
              </div>
            </div>
  ...
  return (
    <PublicLayout>
      {/* Main Content */}
      <section className="py-8 md:py-16 bg-white -mt-12 sm:mt-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Back Button */}
          <div className="mb-8">
            <button
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            {(
              <div className="relative aspect-[16/9] overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <div className={`inline-flex items-center px-3 py-1.5 rounded-full text-sm font-semibold ${categoryInfo.color}`}>
                    <categoryInfo.icon className="w-4 h-4 mr-2" />
                    {categoryInfo.label}
                  </div>
                </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-8 space-y-6">
                {/* Quick Info Card */}
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                  <div className="mb-4 inline-flex items-center px-2 py-1 rounded-full bg-gray-100 text-gray-700 text-xs font-semibold">
                    Quick Info
                  </div>
                  <div className="space-y-3">
                  {announcement.event_date && (
                      <div className="flex items-start gap-3">
                        <div className="w-8 h-8 rounded-lg bg-blue-50 ring-1 ring-blue-200 flex items-center justify-center flex-shrink-0">
                        <Calendar className="w-4 h-4 text-blue-600" />
                      </div>
                      <div>
                          <div className="text-xs uppercase tracking-wide text-gray-500">Event Date</div>
                          <div className="text-sm text-gray-800">{formatDateTime(announcement.event_date)}</div>
                      </div>
                    </div>
                  )}
                  {announcement.location && (
                      <div className="flex items-start gap-3">
                        <div className="w-8 h-8 rounded-lg bg-green-50 ring-1 ring-green-200 flex items-center justify-center flex-shrink-0">
                        <MapPin className="w-4 h-4 text-green-600" />
                      </div>
                      <div>
                          <div className="text-xs uppercase tracking-wide text-gray-500">Location</div>
                          <div className="text-sm text-gray-800">{announcement.location}</div>
                      </div>
                    </div>
                  )}
                    {announcement.end_date && (
                      ...
                      <div>
                          <div className="text-xs uppercase tracking-wide text-gray-500">Deadline</div>
                          <div className="text-sm text-red-600">{formatDateTime(announcement.end_date)}</div>
                        </div>
                      </div>
                    )}
                    {!announcement.event_date && !announcement.location && !announcement.end_date && (
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <span className="text-sm text-gray-700">2nd Floor, Archive Building, New Municipal Government Center, Brgy. Don Luis, San Jose, Batangas</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-gray-50 ring-1 ring-gray-200 flex items-center justify-center">
                        <Mail className="w-4 h-4 text-gray-600" />
                      </div>
                      <span className="text-sm text-gray-700">lydo@sanjosebatangas.gov.ph</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-gray-50 ring-1 ring-gray-200 flex items-center justify-center">
                        <Phone className="w-4 h-4 text-gray-600" />
                      </div>
                      <span className="text-sm text-gray-700">(043) 779-8550 loc. 4006</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full rounded-2xl p-4 bg-gradient-to-br from-indigo-500/10 to-blue-500/10 ring-1 ring-indigo-100 hover:shadow-md transition-shadow flex items-center justify-between"
                    >
                      <div className="flex items-center gap-3">
                        <div className="h-11 w-11 rounded-xl bg-indigo-500 text-white grid place-items-center shadow-sm"><Share2 className="w-5 h-5" /></div>
                        <div className="text-left">
                          <div className="text-sm font-semibold text-indigo-900">Native Share</div>
                          <div className="text-xs text-indigo-700/80">Use device share menu</div>
                        </div>
                      </div>
                      <ChevronRight className="w-4 h-4 text-indigo-700/70" />
                    </button>
                    ...
                    <button
                      ...
                      className="w-full rounded-2xl p-4 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 ring-1 ring-emerald-100 hover:shadow-md transition-shadow flex items-center justify-between"
                    >
                      <div className="flex items-center gap-3">
                        <div className="h-11 w-11 rounded-xl bg-emerald-500 text-white grid place-items-center shadow-sm"><ExternalLink className="w-5 h-5" /></div>
                        <div className="text-left">
                          <div className="text-sm font-semibold text-emerald-900">Copy Link</div>
                          <div className="text-xs text-emerald-700/80">{copied ? 'Link copied!' : 'Share via clipboard'}</div>
                        </div>
                      </div>
                      <ChevronRight className="w-4 h-4 text-emerald-700/70" />
                    </button>
                    ...
                    <div className="grid grid-cols-5 gap-3 place-items-center">
                      ...
                      <button
                        ...
                        className="h-14 w-14 rounded-2xl bg-white ring-1 ring-gray-200 shadow-sm flex items-center justify-center hover:shadow-md transition-shadow"
                      >
                        <div className="h-8 w-8 rounded-full bg-[#1877F2] grid place-items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4 w-4 fill-white"><path d="M22 12a10 10 0 1 0-11.563 9.875v-6.988H7.898V12h2.539V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.772-1.63 1.562V12h2.773l-.443 2.887h-2.33v6.988A10.002 10.002 0 0 0 22 12Z"/></svg>
                        </div>
                      ...
                      >
                        <div className="h-8 w-8 rounded-full bg-black grid place-items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4 w-4 fill-white"><path d="M18.243 2H21l-6.485 7.41L22 22h-6.59l-5.16-6.73L4.41 22H2l6.93-7.92L2 2h6.59l4.63 6.04L18.243 2Zm-.968 18h1.87L8.86 4H6.99l10.285 16Z"/></svg>
                        </div>
                      ...
                      <button
                        ...
                        className="h-14 w-14 rounded-2xl bg-white ring-1 ring-gray-200 shadow-sm flex items-center justify-center hover:shadow-md transition-shadow"
                      >
                        <div className="h-8 w-8 rounded-[10px] bg-gradient-to-br from-[#F58529] via-[#DD2A7B] to-[#8134AF] grid place-items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4 w-4 fill-white"><path d="M7 2h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V7a5 5 0 0 1 5-5Zm0 2a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3H7Zm5 3a5 5 0 1 1 0 10 5 5 0 0 1 0-10Zm0 2.2a2.8 2.8 0 1 0 0 5.6 2.8 2.8 0 0 0 0-5.6Zm4.6-.8a1 1 0 1 1 0 2 1 1 0 0 1 0-2Z"/></svg>
                        </div>
                    ...
                    <button
                      ...
                      className="w-full rounded-2xl p-4 bg-gradient-to-br from-slate-100 to-slate-50 ring-1 ring-slate-200 hover:shadow-md transition-shadow flex items-center justify-between text-slate-900"
                    >
                      <div className="flex items-center gap-3">
                        <div className="h-11 w-11 rounded-xl bg-white grid place-items-center shadow-sm ring-1 ring-slate-300">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 fill-slate-900"><path d="M3 3h6v6H3V3Zm2 2v2h2V5H5Zm8-2h6v6h-6V3Zm2 2v2h2V5h-2ZM3 13h6v6H3v-6Zm2 2v2h2v-2H5Zm12-2h2v2h2v2h-2v2h-2v-2h-2v-2h2v-2Zm-4 0h2v2h-2v-2Zm0 4h2v2h-2v-2Z"/></svg>
                        </div>
                        <div className="text-left">
                          <div className="text-sm font-semibold">QR Code</div>
                          <div className="text-xs text-slate-600">Generate scannable code</div>
                        </div>
                      </div>
      ...
      {showQR && (
        <div className="fixed inset-0 z-[9999] bg-black/40 flex items-center justify-center p-4" onClick={() => setShowQR(false)}>
          <div className="bg-white rounded-2xl shadow-xl p-6" onClick={(e) => e.stopPropagation()}>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Scan to open</h3>
            <img
              src={`https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=${encodeURIComponent(window.location.href)}`}
              alt="QR Code"
              className="w-56 h-56"
            />
            <button onClick={() => setShowQR(false)} className="mt-4 w-full rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-800 py-2 font-medium">Close</button>
          </div>
        </div>
      )}
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Related Announcements</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Discover more programs and opportunities that might interest you.</p>
          </div>
                  ...
                  >
                    ...
                    <div className="relative overflow-hidden flex-shrink-0 aspect-[16/9]">
                      ...
                      <div className="absolute top-2 left-2">
                        <div className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold ${categoryInfo.color}`}>
                    ...
                    <div className="flex flex-col flex-1 p-6">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          <h3 className="font-semibold text-gray-900 mb-2 line-clamp-2 text-lg">{item.title}</h3>
                      ...
                      <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                        <div 
                          className="relative inline-flex items-center text-gray-400 group-hover:text-[#24345A] transition-colors w-32"
                        >
