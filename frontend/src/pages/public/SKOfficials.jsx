    ...
    <PublicLayout>
      ...
      <section className="pt-16 pb-8 md:py-16 bg-white">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">SK Federation Officers</h2>
          <p className="text-gray-700 max-w-3xl">Meet the current officers of the Sangguniang Kabataan Federation in San Jose, Batangas.</p>
           ...
           <div className="space-y-8">
             ...
             <div className="flex justify-center">
               <div className="group relative max-w-sm w-full">
                 <div className="absolute -inset-2 rounded-3xl bg-gradient-to-r from-yellow-300/30 via-amber-200/25 to-yellow-300/30 opacity-0 blur-xl transition-opacity duration-300 group-hover:opacity-100 pointer-events-none" aria-hidden="true" />
                 <div className="relative bg-white rounded-3xl shadow-xl ring-2 ring-yellow-200 overflow-hidden transition-all duration-300 group-hover:shadow-2xl">
                   {/* Header with special gradient */}
                   <div className="h-24 bg-gradient-to-r from-yellow-400 via-amber-500 to-yellow-400 relative">
                     <div className="absolute inset-0 bg-black/10"></div>
                   </div>
                   
                   {/* Profile Photo */}
                   <div className="relative -mt-16 mb-6">
                     <div className="w-32 h-32 mx-auto rounded-full overflow-hidden ring-6 ring-white shadow-2xl">
                       <img
                   ...
                   <div className="px-8 pb-8 text-center">
                     <div className="inline-flex items-center px-4 py-2 text-sm font-bold rounded-full bg-gradient-to-r from-yellow-100 to-amber-100 text-amber-800 ring-2 ring-yellow-200 mb-4">
                       {federationOfficers[0].position}
                     </div>
                     <h3 className="text-2xl font-bold text-gray-900 mb-2">{federationOfficers[0].name}</h3>
                     <p className="text-gray-600 text-sm font-medium">{federationOfficers[0].barangay}</p>
                   </div>
                 </div>
               </div>
             </div>
               ...
               <div className="group relative max-w-xs w-full">
                 ...
                 <div className="relative bg-white rounded-2xl shadow-lg ring-2 ring-green-200 overflow-hidden transition-all duration-300 group-hover:shadow-xl">
                   ...
                   <div className="relative -mt-12 mb-4">
                     <div className="w-28 h-28 mx-auto rounded-full overflow-hidden ring-4 ring-white shadow-lg">
                       <img
                   ...
                   <div className="px-6 pb-6 text-center">
                     <div className="inline-flex items-center px-3 py-1 text-xs font-bold rounded-full bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 ring-2 ring-green-200 mb-3">
                       {federationOfficers[1].position}
                     </div>
                     <h3 className="text-xl font-bold text-gray-900 mb-1">{federationOfficers[1].name}</h3>
                     <p className="text-gray-600 text-sm font-medium">{federationOfficers[1].barangay}</p>
                   </div>
                 </div>
               </div>
             </div>
               ...
               {federationOfficers.slice(2).map((officer, index) => (
                 <div key={index + 2} className="group relative">
                   ...
                   <div className="relative bg-white rounded-2xl shadow-md ring-1 ring-gray-200 overflow-hidden transition-all duration-300 group-hover:shadow-lg">
                     ...
                     <div className="h-16 bg-gradient-to-r from-[#24345A] to-[#E7EBFF] relative">
                       <div className="absolute inset-0 bg-black/10"></div>
                     </div>
                     
                     {/* Profile Photo */}
                     <div className="relative -mt-10 mb-3">
                       <div className="w-20 h-20 mx-auto rounded-full overflow-hidden ring-3 ring-white shadow-md">
                         <img
                     ...
                     <div className="px-4 pb-4 text-center">
                       <div className="inline-flex items-center px-2.5 py-1 text-xs font-semibold rounded-full bg-gradient-to-r from-[#E7EBFF] to-[#F1E9FF] text-[#24345A] ring-1 ring-gray-200 mb-2">
                         {officer.position}
                       </div>
                       <h3 className="text-lg font-bold text-gray-900 mb-1">{officer.name}</h3>
                       <p className="text-gray-600 text-xs font-medium">{officer.barangay}</p>
                     </div>
                   </div>
                 </div>
               ))}
      ...
      <section className="pt-8 pb-8 md:py-16 bg-white">
        ...
        >
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-[#E7EBFF] text-[#24345A] text-xs font-semibold uppercase tracking-wider mb-2">Directory</div>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">SK Chairpersons & Contact Directory</h2>
          <p className="text-gray-600 max-w-3xl">Find and contact SK Chairpersons across all barangays in San Jose, Batangas.</p>
          <div className="mt-5 mb-10 h-[2px] w-full max-w-4xl bg-gradient-to-r from-[#E7EBFF] via-[#F1E9FF] to-[#FDE7F1] opacity-90 rounded-full" aria-hidden="true" />
          ...
          <div className="mb-8">
            <div className="relative max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#24345A]/20 focus:border-[#24345A] transition-colors"
              />
            </div>
          </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
             {filteredChairpersons.map((person, index) => (
               <div key={index} className="group">
                 <div className="bg-gradient-to-br from-white via-gray-50 to-white rounded-3xl p-6 shadow-lg ring-1 ring-gray-200 hover:shadow-xl transition-all duration-300 hover:ring-[#24345A]/30">
                   {/* Top Section with Photo and Basic Info */}
                   <div className="flex items-start gap-4 mb-4">
                     {/* Profile Photo */}
                     <div className="flex-shrink-0">
                       <div className="w-16 h-16 rounded-2xl overflow-hidden ring-2 ring-[#24345A]/20 shadow-md">
                         <img
                     ...
                     <div className="flex-1 min-w-0">
                       <div className="inline-flex items-center px-2 py-1 text-xs font-bold rounded-lg bg-[#24345A] text-white mb-2">
                         SK Chairperson
                       </div>
                       <h3 className="text-lg font-bold text-gray-900 mb-1 truncate">{person.name}</h3>
                       <div className="flex items-center gap-1.5">
                         <MapPin className="w-3.5 h-3.5 text-[#24345A] flex-shrink-0" />
                         <span className="text-sm text-gray-600 font-medium truncate">{person.barangay}</span>
                       </div>
                     </div>
                   </div>
                   
                   {/* Contact Section */}
                   <div className="bg-gradient-to-r from-[#E7EBFF] to-[#F1E9FF] rounded-2xl p-4 ring-1 ring-[#24345A]/10">
                     <div className="flex items-center justify-between">
                       <div className="flex items-center gap-3">
                         <div className="w-10 h-10 rounded-xl bg-[#24345A] flex items-center justify-center">
                           <Phone className="w-5 h-5 text-white" />
                         </div>
                         <div>
                           <p className="text-xs text-gray-600 font-medium">Contact Number</p>
                           <p className="text-sm font-bold text-[#24345A]">{person.contact}</p>
                         </div>
                       </div>
                       <div className="w-8 h-8 rounded-full bg-white/80 flex items-center justify-center shadow-sm">
                         <Phone className="w-4 h-4 text-[#24345A]" />
                       </div>
                     </div>
                   </div>
                 </div>
      ...
      <section className="pt-8 pb-8 md:py-16 bg-white">
        ...
        >
          <div className="text-center mb-12">
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-[#E7EBFF] text-[#24345A] text-xs font-semibold uppercase tracking-wider mb-2">Complete List</div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">SK Officials Complete List</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">Browse the complete list of SK officials from all barangays. Click on any barangay card to view the detailed list of Chairperson and Councilors.</p>
            <div className="mt-5 h-[2px] w-24 bg-gradient-to-r from-[#E7EBFF] via-[#F1E9FF] to-[#FDE7F1] opacity-90 rounded-full mx-auto" aria-hidden="true" />
          </div>
          ...
          {filteredBarangayOfficials.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div 
                key={index} 
                className={`group bg-white rounded-3xl shadow-lg ring-1 ring-gray-200 overflow-hidden transition-all duration-300 hover:shadow-xl hover:ring-[#24345A]/20 cursor-pointer ${
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-16 h-16 rounded-2xl bg-[#24345A] flex items-center justify-center flex-shrink-0">
                      <MapPin className="w-8 h-8 text-white" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="text-xl font-bold text-gray-900">{barangay.barangay}</h3>
                    </div>
                ...
                <div className={`overflow-hidden transition-all duration-300 ease-out ${
                  expandedCards[index] ? 'max-h-[800px] opacity-100' : 'max-h-0 opacity-0'
                }`}>
                  <div className="px-6 pb-6 space-y-4">
                    ...
                    {/* Chairperson Details */}
                    <div className="bg-purple-100 rounded-2xl p-4 ring-1 ring-purple-200">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-xl bg-[#24345A] flex items-center justify-center">
                          <Users className="w-6 h-6 text-white" />
                        </div>
                        <div>
                          <p className="text-sm font-medium text-gray-700">SK Chairperson</p>
                          <p className="text-lg font-bold text-[#24345A]">{barangay.chairperson}</p>
                        </div>
                      </div>
                    </div>

                    {/* Councilors */}
                    <div className="bg-gray-50 rounded-2xl p-4 ring-1 ring-gray-200">
                      <div className="flex items-center gap-3 mb-3">
                        <div className="w-10 h-10 rounded-xl bg-[#E7EBFF] flex items-center justify-center">
                          <Users className="w-5 h-5 text-[#24345A]" />
                        </div>
                        <div>
                          <p className="text-sm font-medium text-gray-600">SK Councilors</p>
                          <p className="text-xs text-gray-500">{barangay.councilors.length} members</p>
                        </div>
                      </div>
                      <div className="space-y-2 max-h-48 overflow-y-auto">
                        {barangay.councilors.map((councilor, councilorIndex) => (
                          <div key={councilorIndex} className="flex items-center gap-3 p-2 bg-white rounded-lg ring-1 ring-gray-100">
                            <div className="w-6 h-6 rounded-full bg-[#24345A]/10 flex items-center justify-center flex-shrink-0">
                              <div className="w-2 h-2 rounded-full bg-[#24345A]"></div>
                            </div>
                            <span className="text-sm font-medium text-gray-700">{councilor}</span>
                          </div>
                        ))}
                      </div>
                    </div>
