        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div className="relative rounded-2xl p-6 bg-gradient-to-br from-white via-gray-50/50 to-white ring-1 ring-gray-200 shadow-lg transition-all duration-300 group-hover:shadow-xl group-hover:scale-105">
                <div className="w-12 h-12 rounded-xl grid place-items-center bg-[#E7EBFF] text-[#24345A] ring-1 ring-gray-200 mx-auto mb-4">
                  <Building2 className="w-6 h-6" />
                </div>
                <div className="text-3xl font-bold text-[#24345A] mb-2">
                  <AnimatedNumber value={totalBarangays} />
                </div>
                <div className="text-gray-600 font-medium">Total Barangays</div>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="relative rounded-2xl p-6 bg-gradient-to-br from-white via-gray-50/50 to-white ring-1 ring-gray-200 shadow-lg transition-all duration-300 group-hover:shadow-xl group-hover:scale-105">
                ...
                <div className="text-gray-600 font-medium">Total Youth Population</div>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="relative rounded-2xl p-6 bg-gradient-to-br from-white via-gray-50/50 to-white ring-1 ring-gray-200 shadow-lg transition-all duration-300 group-hover:shadow-xl group-hover:scale-105">
                ...
                <div className="text-gray-600 font-medium">Average Youth per Barangay</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#24345A] focus:border-transparent transition-all duration-200"
              />
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#24345A] focus:border-transparent text-sm"
                >
      ...
      <section className="py-16 bg-white relative overflow-hidden">
        ...
        >
          ...
          <div className="mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Barangay Directory</h2>
            <p className="text-gray-600 max-w-3xl text-lg">
              Discover detailed information about each barangay in San Jose, Batangas.
            </p>
            <div className="mt-5 mb-10 h-[2px] w-full max-w-4xl bg-gradient-to-r from-[#E7EBFF] via-[#F1E9FF] to-[#FDE7F1] opacity-90 rounded-full" />
          </div>
          ...
          {error && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Failed to Load Barangay Directory</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredBarangays.map((barangay) => (
                <div key={barangay.barangay_id} className="group relative">
                  ...
                  {/* Card */}
                  <div className="relative rounded-2xl p-6 bg-gradient-to-br from-white via-gray-50/50 to-white ring-1 ring-gray-200 shadow-lg transition-all duration-300 group-hover:shadow-xl group-hover:scale-105 overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h3 className="text-lg font-bold text-gray-900">{barangay.barangay_name}</h3>
                            <p className="text-sm text-gray-500">{barangay.barangay_id}</p>
                          </div>
                        </div>
                        <button
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div className="text-center py-3 bg-gray-50 rounded-lg">
                          <div className="text-2xl font-bold text-[#24345A]">{barangay.youth_count}</div>
                          <div className="text-xs text-gray-600">Youth</div>
                        </div>
                        <div className="text-center py-3 bg-gray-50 rounded-lg">
                          <div className="text-2xl font-bold text-[#24345A]">{barangay.total_youth_count}</div>
                      ...
                      {selectedBarangay === barangay.barangay_id && (
                        <div className="mt-4 pt-4 border-t border-gray-200 space-y-4">
                          {/* Puroks */}
                          <div>
                            <h4 className="text-sm font-semibold text-gray-900 mb-2">Puroks</h4>
                            <div className="flex flex-wrap gap-1">
                              {barangay.puroks && barangay.puroks.length > 0 ? (
                                ...
                                <span className="text-sm text-gray-500">No puroks data available</span>
                              )}
                            </div>
                          </div>
          ...
          {!loading && !error && filteredBarangays.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 mb-2">No barangays found</p>
