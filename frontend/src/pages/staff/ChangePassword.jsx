  ...
  const handleChangePassword = async () => {
    ...
    const confirmed = await (confirmation.showConfirmation
      ? confirmation.showConfirmation({
          ...
          message: 'This will update your account password. You will need to log in again.',
    ...
    try {
      ...
      if (response.success) {
        ...
        showSuccessToast && showSuccessToast('Password Changed', response.message || 'Your password has been updated successfully.');
      } else {
        // Handle API errors
        ...
        <div className="xl:col-span-2">
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100">
              ...
              <p className="text-sm text-gray-500 mt-1">Enter your current password and choose a new secure password</p>
            </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-200 overflow-hidden">
            ...
            <div className="p-6 space-y-2">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-blue-800">At least 8 characters long</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <CheckCircle2 className="w-4 h-4 text-blue-600" />
                <span className="text-blue-800">Contains uppercase and lowercase letters</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <CheckCircle2 className="w-4 h-4 text-blue-600" />
                <span className="text-blue-800">Includes numbers and special characters</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <CheckCircle2 className="w-4 h-4 text-blue-600" />
                <span className="text-blue-800">Different from your current password</span>
              </div>
          </div>
        </div>
        </div>
