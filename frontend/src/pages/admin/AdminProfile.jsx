            ...
            {activeTab === 'settings' && (
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:justify-end pt-4 border-t border-gray-100">
                  <button type="button" onClick={handleCancelSettings} className="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium rounded-lg border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors">Cancel</button>
                  <button type="button" disabled={!dirtySettings || !validSettings || isSavingSettings} onClick={handleSaveSettings} className={`inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium rounded-lg focus:outline-none focus:ring-2 transition-colors ${dirtySettings && validSettings && !isSavingSettings ? 'bg-orange-500 text-white hover:bg-orange-600 focus:ring-orange-500' : 'bg-gray-300 text-gray-500 cursor-not-allowed'}`}>{isSavingSettings ? 'Saving…' : 'Save'}</button>
                </div>
              </div>
            )}
          </form>
