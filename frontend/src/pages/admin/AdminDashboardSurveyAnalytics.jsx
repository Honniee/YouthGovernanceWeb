 ...
 * Analytics component for displaying active survey batch analytics in the dashboard
 * Props:
 ...
 */
const AdminDashboardSurveyAnalytics = ({ responses = [], startDate, endDate, activeSurvey }) => {
  ...
  return (
    <div className="space-y-8">
      ...
      <ActiveSurveyBanner
        ...
        isLoading={false}
        onNavigateToActive={() => window.location.href = '/admin/survey/batches?filter=active'}
        onCreateSurvey={() => window.location.href = '/admin/survey/batches'}
        onViewSurvey={() => {
          if (activeSurvey) {
            const batchId = activeSurvey.batchId || activeSurvey.batch_id;
            window.location.href = `/admin/survey/batches/batch-report?batchId=${batchId}`;
          }
        }}
        variant="surveys"
      />
...
export default AdminDashboardSurveyAnalytics;
